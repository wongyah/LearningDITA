...
本讲将教你如何按照最佳实践编写概念型主题。你将体验内容与格式分离、DITA元素的一致性以及语义丰富的妙处。

## 相关资料

- [《DITA写作指南》：内容与格式分离](https://www.oxygenxml.com/dita/styleguide/Authoring_Concepts/c_Introduction_to_the_Separation_of_Content.html)
